...
function Navbar() {
  ...
  return (
    <header className="relative flex justify-between items-center px-[1rem] py-6 w-full text-white font-semibold text-[16px] md:px-[6rem] scroll-smooth">
      ...
      {menuIsOpen && (
        <div className="fixed flex flex-row-reverse justify-between text-[14px] py-[2rem] px-[1rem] top-0 left-0 w-full font-bold h-[30rem] bg-[white] text-[#04251C] md:hidden">
          <IoMdClose
