function About() {
  return (
    <div className="mb-[5rem] border-b-[lightgray] border-b pb-[7rem] flex flex-col gap-6 px-[2rem] md:flex md:flex-row-reverse md:justify-center md:items-center md:px-[5rem] md:gap-[10rem]">
